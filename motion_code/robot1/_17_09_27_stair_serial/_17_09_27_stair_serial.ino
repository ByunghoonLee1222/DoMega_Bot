...
int Offset1[MOTORS] = {1366,  1593,  2725,  512,  2048,  1593,  2725,  512, 4095};
int Offset2[MOTORS] = {1366,  1593,  2725,  512,  2048,  1593,  2725,  512, 4095};
...
void obs_test()
{
   //int Id[MOTORS] = {61ex,  62mx,  63ex,  64,  31ex,  32mx,  33ex,  34, 82};
      motion_walk( 1520,  58,  1356,  -300,  -1520,  58,  1356,  300,  0);
      delay(2000);
...
void obs_test2()
{
   //int Id[MOTORS] = {61,  62,  63,  64,  31,  32,  33,  34, 82};
      motion_walk( 0,  -397,  0,  0,  0,  -397,  0,  0,  0);
      delay(500);
      motion_walk( -1520,  227,  0,  300,  1520,  227,  0,  -300,  0);
      delay(1000);
