...
int Offset1[MOTORS] = {1320,  1638,  2620,  512,  2048,  1638,  2620,  512};
int Offset2[MOTORS] = {1320,  1638,  2620,  512,  2048,  1638,  2620,  512};
...
void wheel_mode()
{
                  //Left             //Right  
  //int Id[MOTORS] = {61,  62,  63,  64,  31,  32,  33,  34};
         motion_walk(  1470,  3357,  -572,  290,  0,  0,  0,  -300); 
          delay(300);
