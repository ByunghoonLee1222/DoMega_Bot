...
int Offset1[MOTORS] = {2048,  1688,  2595,  512,  2388,  1688,  2595,  512,20};
int Offset2[MOTORS] = {2048,  1688,  2595,  512,  2388,  1688,  2595,  512,20};
...
void wheel_mode()  //leg up
{
  ...
  //int Id[MOTORS] = {11,  12,  13,  14,  21,  22,  23,  24};
         ...
         motion_walk(  -1365,  2485,  -729,  -300,  1365,  2485,  -729,  290,  0); 
          delay(300);
...
{
  //int Id[MOTORS] = {11,  12,  13,   14,      21,   22,   23,   24,  72};
      motion_walk( 1540,  58,  1356,  -300,  -1540,  58,  1356,  300,  0);
      delay(2000);
...
void obs_test2() // obs down 'y'
{
   //int Id[MOTORS] = {61,  62,  63,  64,  31,  32,  33,  34, 82};
      motion_walk( 0,  -397,  0,  0,  0,  -397,  0,  0,  0);
      delay(500);
      motion_walk( -1540,  227,  0,  300,  1540,  227,  0,  -300,  0);
      delay(1000);
...
//      delay(2000);
   ...
   {
      flag = 0;
      Dxl.writeWord(ID_Right_Wheel, Moving_Speed, 0x400 | 80);// go ahead with velocity 300
      Dxl.writeWord(ID_Left_Wheel, Moving_Speed,  80);
      delay(10);
      temp[0] = 'p';
   }
        else if (temp[0] == '4')
   {
      flag = 0;
      Dxl.writeWord(ID_Left_Wheel, Moving_Speed, 0x400 | 80);// go ahead with velocity 300
      Dxl.writeWord(ID_Right_Wheel, Moving_Speed,  80);
      delay(10);
      temp[0] = 'p';
   }
         else if (temp[0] == '5')
   {
      flag = 0;
      Dxl.writeWord(ID_Left_Wheel, Moving_Speed, 0x400 | 30);// go ahead with velocity 300
      Dxl.writeWord(ID_Right_Wheel, Moving_Speed,0x400 | 30);
      delay(10);
      temp[0] = 'p';
   }
            else if (temp[0] == '6')
   {
      flag = 0;
      Dxl.writeWord(ID_Left_Wheel, Moving_Speed,  30);// go ahead with velocity 300
      Dxl.writeWord(ID_Right_Wheel, Moving_Speed,  30);
      delay(10);
      temp[0] = 'p';
   }
   else if (temp[0] == 'i')
   {
      flag = 0;
      Dxl.writeWord(ID_Right_Wheel, Moving_Speed, 0x400 | 400);// go ahead with velocity 300
      Dxl.writeWord(ID_Left_Wheel, Moving_Speed,  400);
      delay(10);
      temp[0] = 'p';
   }
      else if (temp[0] == 'j')
   {
      flag = 0;
      Dxl.writeWord(ID_Left_Wheel, Moving_Speed, 0x400 | 400);// go ahead with velocity 300
      Dxl.writeWord(ID_Right_Wheel, Moving_Speed,  400);
      delay(10);
      temp[0] = 'p';
   }
       else if (temp[0] == 'q')
   {
      flag = 0;
      Dxl.writeWord(ID_Left_Wheel, Moving_Speed, 0x400 | 20);// go ahead with velocity 300
      Dxl.writeWord(ID_Right_Wheel, Moving_Speed,0x400 | 20);
      delay(1);
      temp[0] = 'p';
   }
         else if (temp[0] == 'e')
   {
      flag = 0;
      Dxl.writeWord(ID_Left_Wheel, Moving_Speed,  20);// go ahead with velocity 300
      Dxl.writeWord(ID_Right_Wheel, Moving_Speed,  20);
      delay(1);
      temp[0] = 'p';
   }
      else if (temp[0] == 'p')
